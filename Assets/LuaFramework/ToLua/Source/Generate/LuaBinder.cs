...
public static class LuaBinder
{
	public static void Bind(LuaState L)
	{
		...
		LuaFramework_MScenceManagerWrap.Register(L);
		L.EndModule();
		...
		L.RegFunction("Action_RoleCtrl", System_Action_RoleCtrl);
		L.EndModule();
		L.EndModule();
		L.BeginPreLoad();
	...
	[MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
	static int System_Action_RoleCtrl(IntPtr L)
	{
		try
		{
			int count = LuaDLL.lua_gettop(L);
			...
			if (count == 1)
			{
				Delegate arg1 = DelegateTraits<System.Action<RoleCtrl>>.Create(func);
				ToLua.Push(L, arg1);
			}
			else
			{
				LuaTable self = ToLua.CheckLuaTable(L, 2);
				Delegate arg1 = DelegateTraits<System.Action<RoleCtrl>>.Create(func, self);
				ToLua.Push(L, arg1);
			}
			return 1;
		}
