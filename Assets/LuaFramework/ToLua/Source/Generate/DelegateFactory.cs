...
public class DelegateFactory
{
	...
	public static void Register()
	{
		...
		dict.Add(typeof(System.Action<RoleCtrl>), factory.System_Action_RoleCtrl);
		...
		DelegateTraits<System.Action<RoleCtrl>>.Init(factory.System_Action_RoleCtrl);
		...
		TypeTraits<System.Action<RoleCtrl>>.Init(factory.Check_System_Action_RoleCtrl);
		...
		StackTraits<System.Action<RoleCtrl>>.Push = factory.Push_System_Action_RoleCtrl;
	}
	...
	class System_Action_RoleCtrl_Event : LuaDelegate
	{
		public System_Action_RoleCtrl_Event(LuaFunction func) : base(func) { }
		public System_Action_RoleCtrl_Event(LuaFunction func, LuaTable self) : base(func, self) { }

		public void Call(RoleCtrl param0)
		{
			func.BeginPCall();
			func.Push(param0);
			func.PCall();
		...
		public void CallWithSelf(RoleCtrl param0)
		{
			func.BeginPCall();
			func.Push(self);
			func.Push(param0);
	...
	public System.Action<RoleCtrl> System_Action_RoleCtrl(LuaFunction func, LuaTable self, bool flag)
	{
		if (func == null)
		{
			System.Action<RoleCtrl> fn = delegate(RoleCtrl param0) { };
			return fn;
		}

		if(!flag)
		{
			System_Action_RoleCtrl_Event target = new System_Action_RoleCtrl_Event(func);
			System.Action<RoleCtrl> d = target.Call;
			target.method = d.Method;
			return d;
		}
		else
		{
			System_Action_RoleCtrl_Event target = new System_Action_RoleCtrl_Event(func, self);
			System.Action<RoleCtrl> d = target.CallWithSelf;
			target.method = d.Method;
			return d;
		}
	}

	bool Check_System_Action_RoleCtrl(IntPtr L, int pos)
	{
		return TypeChecker.CheckDelegateType(typeof(System.Action<RoleCtrl>), L, pos);
	}

	void Push_System_Action_RoleCtrl(IntPtr L, System.Action<RoleCtrl> o)
	{
		ToLua.Push(L, o);
	}
