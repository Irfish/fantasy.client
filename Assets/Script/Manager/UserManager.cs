...
namespace fantasy.manager
{
    public class UserManager : Singleton<UserManager>
    {
        ...
        public UserManager()
        {
            fantasy.e.Event.Instance.AddListener("OnTcpConnected", OnTcpConnected);
        ...
        public void LoginSuccessCallback(string data)
        {
            ...
            fantasy.net.SocketClient.Instance.Connecte(host, port);
        ...
        public override void Dispose()
        {
            ...
            fantasy.e.Event.Instance.RemoveListener("OnTcpConnected", OnTcpConnected);
